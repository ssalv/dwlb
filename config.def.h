...
// font
static char *fontstr = "BlexMono Nerd Font:size=12:style=Bold";
...
static pixman_color_t active_bg_color = HEX_COLOR(0x080808ff);      // moonflyBg

static pixman_color_t occupied_fg_color = HEX_COLOR(0x80a0ffff);    // moonflyBlue
static pixman_color_t occupied_bg_color = HEX_COLOR(0x080808ff);    // moonflyBg

static pixman_color_t inactive_fg_color = HEX_COLOR(0x444444ff);    // moonflyGray
static pixman_color_t inactive_bg_color = HEX_COLOR(0x080808ff);    // moonflyBg

static pixman_color_t urgent_fg_color = HEX_COLOR(0xff5454ff);      // moonflyRed
static pixman_color_t urgent_bg_color = HEX_COLOR(0xcf87e8ff);      // moonflyMagenta

static pixman_color_t middle_bg_color = HEX_COLOR(0x080808ff);      // moonflyBg
